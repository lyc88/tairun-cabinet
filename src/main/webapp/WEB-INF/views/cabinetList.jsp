...
<script id="content" type="text/html">
    ...
    <tr>
        ...
        <td id="images">
            {{each obj.files file}}
                <img class="imgDiv" src="{{file.filePath}}" data-imageId = "{{file.id}}">
            {{/each}}
        </td>
        <td><a class="layui-btn layui-btn-mini news_edit"><i class="layui-icon"></i> 上传</a><a
                class="layui-btn layui-btn-normal layui-btn-mini news_collect"><i class="iconfont icon-edit"></i> 查看</a></td>
    </tr>
    {{/each}}
</script>
