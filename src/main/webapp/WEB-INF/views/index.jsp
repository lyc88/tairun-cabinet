...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/static/layui1.9/css/main.css" media="all" />
</head>
...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav top_menu">
               <%-- <li class="layui-nav-item showNotice" id="showNotice" pc>
                ...
                <li class="layui-nav-item" mobile>
                    <a href="javascript:;" class="mobileAddTab" data-url="${ctx}/static/layui1.9/page/user/changePwd.html"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>设置</cite></a>
                </li>
                <li class="layui-nav-item" mobile>
                ...
                <li class="layui-nav-item" pc>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${ctx}/static/layui1.9/page/login/login.html" class="signOut"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="${ctx}/static/layui1.9/images/face.jpg"></a>
    ...
    <div class="layui-footer footer layui-larry-foot">
        <div class="layui-main">
            <p>Copyright 2017 © 泰润米花网络科技有限公司</p>
        </div>
    </div>
</div>
